...
def edit(generator, latents, indices, semantics=[0], start_distance=-15.0, end_distance=15.0, num_samples=1, step=11):
    ...
    num_sam = num_samples
    edited_latents = []
    for sem_id in tqdm(semantics, desc='Semantic ', leave=False):
